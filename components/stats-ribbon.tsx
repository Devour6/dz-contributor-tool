...
export function StatsRibbon({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-xl bg-cream-5 border border-cream-8 px-4 sm:px-5 py-3 sm:py-3">
      <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 sm:flex sm:items-center sm:gap-6 text-xs sm:text-sm">
